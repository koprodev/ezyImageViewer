# ezy Image Viewer Installer + Portable Preview 1.0.38
...
- `ezyImageViewerSetup-1.0.38-x64-dev-unsigned.exe`: installer with current-user
...
Preview 1.0.38 adds, since 1.0.12: a speech bubble annotation with a draggable
